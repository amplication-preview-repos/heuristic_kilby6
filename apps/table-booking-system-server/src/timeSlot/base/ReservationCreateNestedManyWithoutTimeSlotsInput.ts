...
@InputType()
class ReservationCreateNestedManyWithoutTimeSlotsInput {
...
export { ReservationCreateNestedManyWithoutTimeSlotsInput as ReservationCreateNestedManyWithoutTimeSlotsInput };
